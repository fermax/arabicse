...
export default function LoginPage() {
  const { user, login, error, loading, setError, socialLogin } = useAuth();
  ...
  return (
    <div className={styles.authContainer} dir="rtl">
      <div className={styles.authCard}>
        ...
        <div className={styles.socialSeparator}>أو سجّل الدخول عبر</div>
        ...
        <div className={styles.authFooter}>
          ...
          <Link href="/register" className={styles.authLink}>إنشاء حساب جديد</Link>
        </div>
